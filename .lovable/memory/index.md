...
- [World Effects](mem://features/world-effects-weather-digging) — Held tools, impact particles, shell digging pits, 1Hz weather into UQRC, lava floor
...
- [NPC Wet Work](mem://features/npc-wetwork) — Phase 8: chemistry, inventory, contact-gated wet work, logistic mortality, harmony reproduction, cap 25
- [NPC Swarm Layer](mem://features/npc-swarm-layer) — Phase 7 capsules + resource markers, anchored to shared village, scaffoldBus kill-switch
...
- [World Tools Placement](mem://features/world-tools-placement) — Phase 5: click-to-place via raycast → BuilderBlockEngine; IDB `swarm-world-placements` v1 + BroadcastChannel; emits `world.mutation` for labour credit
